...
mixin _$PolicyModel {
 ...
 int get id; String get title; String get content; String get createdAt; String get updatedAt;
...
@override
String toString() {
  return 'PolicyModel(id: $id, title: $title, content: $content, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int id, String title, String content, String createdAt, String updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  String content,  String createdAt,  String updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PolicyModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  String content,  String createdAt,  String updatedAt)  $default,) {final _that = this;
switch (_that) {
case _PolicyModel():
return $default(_that.id,_that.title,_that.content,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title,  String content,  String createdAt,  String updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _PolicyModel() when $default != null:
return $default(_that.id,_that.title,_that.content,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _PolicyModel extends PolicyModel {
  const _PolicyModel({required this.id, required this.title, required this.content, required this.createdAt, required this.updatedAt}): super._();
