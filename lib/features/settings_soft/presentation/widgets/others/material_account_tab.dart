...
class MaterialAccountTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color cardBgColor = theme.colorScheme.brightness == Brightness.dark
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          MaterialInfoRow(label: 'Account ID', value: '#${user.id}'),
          const SizedBox(height: 12),
          MaterialInfoRow(label: 'Email Address', value: user.email)
        ]
      )
    );
  }
